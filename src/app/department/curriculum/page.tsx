...
export default function CurriculumPage() {
  ...
  const programs: Program[] = [
    ...
    },
    {
      ...
      description:
        "Advanced data science program focusing on machine learning and analytics",
  ...
  const learningOutcomes: LearningOutcome[] = [
    {
      ...
      code: "LO1",
      description:
        "Demonstrate knowledge and understanding of fundamental computer science concepts",
      category: "Knowledge",
    ...
    },
    {
      ...
      code: "LO2",
      description:
        "Apply problem-solving skills to design and implement software solutions",
      category: "Skills",
    ...
    },
    {
      ...
      code: "LO3",
      description:
        "Communicate effectively in technical and non-technical contexts",
      ...
      >
        ...
        <TabsContent value="overview" className="space-y-6">
            ...
            <Card className="bg-white shadow-sm">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-samps-green-600">
                  {
                    programs.filter(
                      (p) => p.accreditationStatus === "Accredited"
                    ).length
                  }
                </div>
                <div className="flex items-center gap-2 mt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="bg-white shadow-sm">
              <CardHeader>
                <CardTitle className="text-samps-gray-700">
                  Accreditation Status
                </CardTitle>
                <CardDescription>
                  Distribution of program accreditation status
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="bg-white shadow-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Distribution of programs by academic level
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
          ...
          <Card className="bg-white shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Programs requiring accreditation review
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    >
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Next review: {program.nextReview}
                        </p>
                      </div>
        ...
        <TabsContent value="programs" className="space-y-6">
          <Card className="bg-white shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Manage and monitor all academic programs
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                  ...
                  {programs.map((program) => (
                    <TableRow key={program.id}>
                      ...
                      <TableCell>
                        ...
                        <div className="text-xs text-gray-500">
                          {Math.ceil(
                            (new Date(program.nextReview).getTime() -
                              new Date().getTime()) /
                              (1000 * 60 * 60 * 24)
                          )}{" "}
                          days
        ...
        <TabsContent value="outcomes" className="space-y-6">
          <Card className="bg-white shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Define and map learning outcomes across programs
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        >
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Program details and management options
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-2 gap-4">
