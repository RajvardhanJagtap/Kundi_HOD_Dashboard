      ...
      <div className="p-2 w-full min-w-0 overflow-x-auto">
        ...
        <div className="mb-4">
          <Button
            ...
            className="flex items-center gap-2 text-gray-700 hover:bg-gray-200 hover:text-gray-900 border-none bg-transparent"
          >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <Button
                ...
                variant="outline"
                className="whitespace-nowrap border-[#026892] text-[#026892] hover:bg-[#026892]/10 bg-transparent"
              >
                {isDownloadingOverall ? (
