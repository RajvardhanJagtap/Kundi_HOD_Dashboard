...
export default function AppealsPage() {
  return (
    <div className="grid gap-6">
      <h1 className="text-2xl font-bold tracking-tight text-gray-900">Student Appeals</h1>
      <p className="text-gray-600 text-sm">Manage and review academic appeals submitted by students.</p>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-50">
                ...
                <TableHead className="text-gray-700">Appeal Type</TableHead>
            ...
            <TableBody>
              <TableRow className="hover:bg-gray-50">
                <TableCell className="font-medium text-gray-800">STU005</TableCell>
                <TableCell className="text-gray-700">Grade Re-evaluation</TableCell>
              ...
              <TableRow className="hover:bg-gray-50">
                <TableCell className="font-medium text-gray-800">STU008</TableCell>
                <TableCell className="text-gray-700">Absence Approval</TableCell>
              ...
              <TableRow className="hover:bg-gray-50">
                <TableCell className="font-medium text-gray-800">STU012</TableCell>
                <TableCell className="text-gray-700">Course Withdrawal</TableCell>
      ...
      <Card className="bg-white shadow-sm border border-gray-200">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-gray-900">Appeal Resolution Status</CardTitle>
          <CardDescription className="text-sm text-gray-600">Overview of resolved and pending appeals.</CardDescription>
        </CardHeader>
        <CardContent>
          <ChartContainer
            config={{
