...
export default function StaffReportsPage() {
  return (
    <div className="grid gap-6">
      <h1 className="text-2xl font-bold tracking-tight text-gray-900">Staff Reports</h1>
      <p className="text-gray-600 text-sm">Generate and view various reports related to departmental staff.</p>
        ...
        <CardContent className="grid gap-4">
          <div className="grid gap-2">
            ...
            <Select defaultValue="workload">
              ...
              <SelectContent>
                <SelectItem value="workload">Staff Workload Summary</SelectItem>
                <SelectItem value="performance">Staff Performance Overview</SelectItem>
                <SelectItem value="leave">Leave Utilization Report</SelectItem>
                <SelectItem value="publications">Staff Publication Report</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="grid gap-2">
